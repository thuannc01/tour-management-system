...
{
    protected $foodSpotRepository;

    public function __construct(IFoodSpotRepository $foodSpotRepository)
    {
        $this->foodSpotRepository = $foodSpotRepository;
    }
    ...
    {
        try {
            $data_res = $this->foodSpotRepository->getAll();
